...
const MENU_UPLOAD_CODE = 'uploadCodeMenu';
...
const rootMenu = new Menu('root')
    ...
    .addChild(new Menu(MENU_UPLOAD_CODE))
...
const openUploadCodeMenu = () => openMenu(MENU_UPLOAD_CODE);
const closeUploadCodeMenu = () => closeMenu(MENU_UPLOAD_CODE);
const uploadCodeMenuOpen = state => state.scratchGui.menus[MENU_UPLOAD_CODE];
